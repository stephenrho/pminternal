...
Finally, bootstrap confidence intervals can be calculated (see https://onlinelibrary.wiley.com/doi/10.1002/sim.9148 for details).

```{r}
confint(mod_iv, parm = c("C", "Brier"), method = "shifted", R=100)
```
